...
import br.com.devmaker.rbn.adapter.PromocoesAdapter;
import br.com.devmaker.rbn.model.Premio;
import br.com.devmaker.rbn.model.Promocao;
import br.com.devmaker.rbn.model.Promotion;
import br.com.devmaker.rbn.model.PromotionPrizesItem;
                        ...
                        case "vigentes":
                            ...
                            try {
                                ...
                                if (dateToday.before(dateVigente) || dateToday.equals(dateVigente)){
                                    ...
                                    BigDecimal decimal = promotion.getTimestamp();

                                    promocao.setTimestamp(decimal.longValue());
                                   /* if (i%2 == 0){
