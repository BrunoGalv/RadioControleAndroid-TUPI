...
import br.com.devmaker.rbn.adapter.MuralListAdapter;
...
import br.com.devmaker.rbn.util.EndlessRecyclerViewScrollListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                ...
                Log.d("idRadio", String.valueOf(posts.getPosts().size()));
        ...
        btnAdicionarPostagem.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (cacheData.getString("userId").equals("")){
                    ...
                    final EscolherDialogFragment dialogListCanais = new EscolherDialogFragment("Selecione o tipo da postagem:", "mural", null, MuralFragment.this);
