...
public class Settings {
    ...
    @com.google.gson.annotations.SerializedName("linkHLS")
    private String linkHLS = null;
    @com.google.gson.annotations.SerializedName("podcastXML")
    private String podcastXML = null;
     ...
     * @return linkHLS
     **/
    public String getLinkHLS() {
        return linkHLS;
    }

    /**
     * Sets the value of linkHLS.
     *
     * @param linkHLS the new value
     */
    public void setLinkHLS(String linkHLS) {
        this.linkHLS = linkHLS;
    }
    ...
    /**
     * Sets the value of podcastXML.
     *
     * @param podcastXML the new value
     */
    public void setPodcastXML(String podcastXML) {
        this.podcastXML = podcastXML;
    }
