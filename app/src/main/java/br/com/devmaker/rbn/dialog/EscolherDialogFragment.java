...
import br.com.devmaker.rbn.adapter.ModalListAdapter;
import br.com.devmaker.rbn.fragment.MuralFragment;
import br.com.devmaker.rbn.model.Channel;
import br.com.devmaker.rbn.model.NavDrawerItem;
...
public class EscolherDialogFragment extends DialogFragment {
    ...
    public EscolherDialogFragment(String modalTitle, String modalTipo, List<Channel> listacanais, MuralFragment muralFragment) {
            ...
            public void onClick(View view, int position) {
                ...
                if (modalTipo.equals("canais")){
                    ...
                    if (abrirTelaTitulo.equals("Texto")) {
                        MuralDialogFragment dialog = new MuralDialogFragment("Postagem de texto", "texto", muralFragment);
                        dialog.setStyle(DialogFragment.STYLE_NORMAL, R.style.DialogFragmentTheme);
                        dialog.show(getActivity().getFragmentManager(), "dialog");
                    } else if (abrirTelaTitulo.equals("Imagem")) {
                        MuralDialogFragment dialog = new MuralDialogFragment("Postagem de imagem", "imagem", muralFragment);
                        dialog.setStyle(DialogFragment.STYLE_NORMAL, R.style.DialogFragmentTheme);
                        dialog.show(getActivity().getFragmentManager(), "dialog");
                    } else if (abrirTelaTitulo.equals("Áudio")) {
                        MuralDialogFragment dialog = new MuralDialogFragment("Postagem de áudio", "audio", muralFragment);
                        dialog.setStyle(DialogFragment.STYLE_NORMAL, R.style.DialogFragmentTheme);
                        dialog.show(getActivity().getFragmentManager(), "dialog");
                    }
                }
