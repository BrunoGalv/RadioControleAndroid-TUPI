...
import br.com.devmaker.rbn.dialog.EditarPerfilDialogFragment;
...
import br.com.devmaker.rbn.util.S3Util;
...
public class PerfilFragment extends Fragment {
    ...
    private class UploadListener implements TransferListener {
        ...
        public void onError(int id, Exception e) {
            Log.e("aaaa", "Error during upload: " + id, e);
            closeWaitDialog();
        }

        @Override
        public void onProgressChanged(int id, long bytesCurrent, long bytesTotal) {
            Log.d("aaaa", String.format("onProgressChanged: %d, total: %d, current: %d",
        ...
        public void onStateChanged(int id, TransferState newState) {
            Log.d("aaaa", "onStateChanged: " + id + ", " + newState);
            ...
            if (check.equals("COMPLETED")){
                new AsyncTask<Void, Void, Void>() {
                    ...
                    protected void onPostExecute(Void result) {
                        ...
                        //profileData.put("phone_number", cacheData.getString("userTelefone"));
