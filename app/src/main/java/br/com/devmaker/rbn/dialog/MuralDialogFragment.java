...
public class MuralDialogFragment extends DialogFragment {
    ...
    private Boolean isProcessingSend = false;
    ...
    public MuralDialogFragment(String modalTitle, String modalTipo, MuralFragment muralFragment) {
                    ...
                    if (modalTipo == "texto") {
                        ...
                        new AsyncTask<Void, Void, Void>() {
                            ...
                            protected void onPostExecute(Void result) {
                                ...
                                customBuilder.setMessage("Postagem realizada com sucesso!");
